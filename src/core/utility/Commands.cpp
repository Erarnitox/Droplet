...
//initialize members:
std::vector<Commands::register_global_slash_commands>    Commands::CommandFunctionPointers::_register_global_slash_commands;
...
// implement geters
std::vector<Commands::register_global_slash_commands>& Commands::CommandFunctionPointers::register_global_slash_commands() {
